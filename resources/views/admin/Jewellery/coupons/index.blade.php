    ...
    <script>
        $(document).ready(function () {
            ...
            function format(rowData) {
                ...
                // In a real application, you would fetch additional data via AJAX
                // For this example, we'll use the available data
                return `
            ...
            $(document).on('click', '.editCouponBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#valid_from').val(coupon.valid_from);
                        $('#valid_until').val(coupon.valid_until);
